...
var uploadreview = multer({
 ...
 //multer setup for review image ends
...
var uploadbij = multer({
 ...
 //multer setup for bij image ends
...
var uploadmotivational = multer({
 ...
 //multer setup for motivational image ends
...
module.exports.upazillalogin=async(req,res)=>{
    res.render('upazilla/login', { title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'' });
    res.send("log");
};
            ...
            if(data.length > 0){
                bcrypt.compare(password,data[0].password,function(err, result) {
                    if(result== true){
                        ...
                        return res.status(200).render('upazilla/login', { title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'Please provide a username and password' });
                    }
                });
            }else{
                return res.status(200).render('upazilla/login', { title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'Please provide a username and password' });
...
module.exports.upazillaDashboard = async(req,res) => {
    ...
    res.render('upazilla/dashboard', { title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'Welcome' });
};
...
module.exports.upazillasignup=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/signup', { title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'',records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/signup', { title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'',records: err });
    })
};
module.exports.upazillasignuppost=async(req,res)=>{
    try {
        ...
        if(data.length > 0){
            res.render('upazilla/signup',{title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'ERROR: The upazilla is already enrolled!',records: ddata})
        }
        else if(password !== confirmPassword){
           res.render('upazilla/signup',{title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'ERROR: Passwords do not match!',records: ddata})
        }
        else{
            ...
            try{
                ...
                res.render('upazilla/signup',{title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'upazilla Registered Successfully!',records: ddata})
            }
            catch (err) {
                console.log(err);
            }
...
module.exports.fieldDayYear=async(req,res)=>{
    ...
    .catch(err => {
        res.render('upazilla/fieldDay/fieldDayYear', { title: 'মাঠ দিবস ',success:'', records: err });
    })
...
module.exports.farmerTraining=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/farmerTraining/farmerTraining', { title: 'কৃষক প্রশিক্ষণ তথ্য',success:'', records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/farmerTraining/farmerTraining', { title: 'কৃষক প্রশিক্ষণ তথ্য',success:'', records: err });
    })
...
module.exports.farmerTrainingYear=async(req,res)=>{
    ...
    .then(data => {
        res.render('upazilla/farmerTraining/farmerTrainingTable', {records: data} ,function(err, html) {
         res.send(html);
        });
    })
    .catch(err => {
        res.render('upazilla/farmerTraining/farmerTrainingYear', { title: 'কৃষক প্রশিক্ষণ তথ্য',success:'', records: err });
    })

};
module.exports.farmerTrainingForm=async(req,res)=>{
    res.render('upazilla/farmerTraining/farmerTrainingForm', { title: 'কৃষক প্রশিক্ষণ',msg:'' ,success:'',user_id: req.session.user_id});
};
...
module.exports.farmerPrize=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/farmerPrize/farmerPrize', { title: 'কৃষক পুরষ্কার তথ্য',success:'', records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/farmerPrize/farmerPrize', { title: 'কৃষক পুরষ্কার তথ্য',success:'', records: err });
    })
...
module.exports.farmerPrizeYear=async(req,res)=>{
    ...
    .then(data => {
        res.render('upazilla/farmerPrize/farmerPrizeTable', {records: data} ,function(err, html) {
         res.send(html);
        });
    })
    .catch(err => {
        res.render('upazilla/farmerPrize/farmerPrizeYear', { title: 'কৃষক পুরষ্কার তথ্য',success:'', records: err });
    })

};
module.exports.farmerPrizeForm=async(req,res)=>{
    res.render('upazilla/farmerPrize/farmerPrizeForm', { title: 'কৃষক পুরষ্কার তথ্য',msg:'' ,success:'',user_id: req.session.user_id});
};
...
module.exports.saaoTraining=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/saaoTraining/saaoTraining', { title: 'এসএএও প্রশিক্ষণ তথ্য',success:'', records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/saaoTraining/saaoTraining', { title: 'এসএএও প্রশিক্ষণ তথ্য',success:'', records: err });
    })
...
module.exports.saaoTrainingYear=async(req,res)=>{
    ...
    .then(data => {
        res.render('upazilla/saaoTraining/saaoTrainingTable', {records: data} ,function(err, html) {
         res.send(html);
        });
    })
    .catch(err => {
        res.render('upazilla/saaoTraining/saaoTrainingYear', { title: 'এসএএও প্রশিক্ষণ তথ্য',success:'', records: err });
    })

};
module.exports.saaoTrainingForm=async(req,res)=>{
    res.render('upazilla/saaoTraining/saaoTrainingForm', { title: 'এসএএও প্রশিক্ষণ তথ্য',msg:'' ,success:'',user_id: req.session.user_id});
};
...
module.exports.review=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/review/review', { title: 'রিভিউ ডিস্কাশন তথ্য',success:'', records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/review/review', { title: 'রিভিউ ডিস্কাশন তথ্য',success:'', records: err });
    })
...
module.exports.reviewYear=async(req,res)=>{
    ...
    .catch(err => {
        res.render('upazilla/review/reviewYear', { title: 'রিভিউ ডিস্কাশন তথ্য',success:'', records: err });
    })

};
module.exports.reviewForm=async(req,res)=>{
    res.render('upazilla/review/reviewForm', { title: 'রিভিউ ডিস্কাশন তথ্য',msg:'' ,success:'',user_id: req.session.user_id});
};
...
module.exports.bij=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/bij/bij', { title: 'বীজ প্রত্যয়ন প্রতিবেদন তথ্য',success:'', records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/bij/bij', { title: 'বীজ প্রত্যয়ন প্রতিবেদন তথ্য',success:'', records: err });
    })
...
module.exports.bijYear=async(req,res)=>{
    ...
    .then(data => {
        res.render('upazilla/bij/bijTable', {records: data} ,function(err, html) {
         res.send(html);
        });
    })
    .catch(err => {
        res.render('upazilla/bij/bijYear', { title: 'বীজ প্রত্যয়ন প্রতিবেদন তথ্য',success:'', records: err });
    })

};
module.exports.bijForm=async(req,res)=>{
    res.render('upazilla/bij/bijForm', { title: 'বীজ প্রত্যয়ন প্রতিবেদন তথ্য',msg:'' ,success:'',user_id: req.session.user_id});
};
...
module.exports.motivational=async(req,res)=>{
    ...
    .then(data => {
        console.log("inside");
        res.render('upazilla/motivational/motivational', { title: 'মোটিভেশনাল ট্যুর তথ্য',success:'', records: data });
    })
    .catch(err => {
        console.log("outside");
        res.render('upazilla/motivational/motivational', { title: 'মোটিভেশনাল ট্যুর তথ্য',success:'', records: err });
    })
...
module.exports.motivationalYear=async(req,res)=>{
    ...
    .then(data => {
        res.render('upazilla/motivational/motivationalTable', {records: data} ,function(err, html) {
         res.send(html);
        });
    })
    .catch(err => {
        res.render('upazilla/motivational/motivationalYear', { title: 'মোটিভেশনাল ট্যুর তথ্য',success:'', records: err });
    })

};
module.exports.motivationalForm=async(req,res)=>{
    res.render('upazilla/motivational/motivationalForm', { title: 'মোটিভেশনাল ট্যুর তথ্য',msg:'' ,success:'',user_id: req.session.user_id});
};
