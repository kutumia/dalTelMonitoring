    ...
    try {
        ...
        if(data.length > 0){
            ...
            try{
                ...
                res.render('dd/signup',{title: 'কৃষক পর্যায়ে উন্নতমানের ডাল,তেল ও মসলা বীজ উৎপাদন সংরক্ষণ ও বিতরণ (৩য় পর্যায়) প্রকল্প ',msg:'dd Registered Successfully!',records: data })
            }
            catch (err) {
                console.log(err);
            }
