...
const {fieldDayYear,farmerTrainingYear,farmerPrizeYear,uploadfieldDay,uploadfarmerPrize,uploadfarmerTraining,farmerPrizeForm,farmerPrizeFormPost,fieldDayForm,fieldDayFormPost,farmerTrainingForm,farmerTrainingFormPost,dashboardMonitoring,upazillasignup,upazillasignuppost,allupazilla,upazillalogin,upazillaloginpost,upazillaDashboard,
    fieldDay,farmerTraining,farmerPrize,saaoTraining,saaoTrainingYear,saaoTrainingForm,uploadsaaoTraining,saaoTrainingFormPost,
    review,reviewYear,reviewForm,uploadreview,reviewFormPost,
    bij,bijYear,bijForm,uploadbij,bijFormPost,
    motivational,motivationalYear,motivationalForm,uploadmotivational,motivationalFormPost} = require('../controllers/upazilla.controller');
